...
class Solver:
    def __init__(self, EAMS, cfg_idx, floc, frun):
        self.model = Model('EAMS')
        self.EAMS = EAMS
        self.CFG_IDX = cfg_idx
        
        self.LogGraph_floc = floc
        self.LogGraph_frun = frun
    ...
    def solve(self):
        ...
        self.logHVACResults()
        self.logforGraph(self.LogGraph_floc+"_ocs", self.LogGraph_frun)
        ...
        self._init_HVACVar()        
        self.solveTime = 0
        self.model = Model('EAMS_Stage2')
        self.EAMS.STANDBY_MODE = 1
